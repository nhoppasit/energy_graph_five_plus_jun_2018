...
pkcnt = length(w);
title(['Current vs Time & Energy vs Time (ON-OFF = ' num2str(pkcnt) ' times) / 1-Apr-2018'])
...
axis([0,24,0,10])
grid on
title('Current Transmission Width vs Time / 1-Apr-2018')
xlabel('Time, h')
...
title('Temperature and Humidity vs Time (Inside - solid line, Outside - dash line) / 1-Apr-2018')
